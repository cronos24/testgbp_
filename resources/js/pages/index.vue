<template>
    <section class="conf-section m-3 p-3">
        ...
        <div
        class="row mx-0 my-2">
        <div class="col"> <label>Nombre Bodega</label> <input type="text" class="form-control" name="" value="" /> </div>
        </div>
        ...
        <div class="row mx-0 my-3">
            ...
            <el-tooltip class="item" effect="light" content="Roberto Gómez Bolaños" placement="top"> <img class="rounded-circle mx-2 obj-cover" height="40" width="40" src="https://www.economist.com/sites/default/files/images/print-edition/20200208_LDD001_0.jpg" alt="" /> </el-tooltip>
            <button
            type="button"
    ...
    <div class="">
        ...
        id="usuarioActivo">
        <label class="custom-control-label" for="usuarioActivo">
          Maria Antonieta
        </label>
        </div>
        </div>
